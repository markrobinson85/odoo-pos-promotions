...
class Promotion(models.Model):
    ...
    notes = fields.Text()
    locations = fields.Many2many("stock.warehouse", string="Locations", track_visibility="onchange")
    ...
    discount_type = fields.Selection([(0, 'Percentage'), (1, 'The Cheapest'), (2, 'Fixed Price Discount')])
